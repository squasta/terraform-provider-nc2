...
> **NOTE: Write these tests FIRST and ensure they FAIL for the right reason before any implementation task in this story begins.**
...
- [ ] TXXX [P] Additional unit tests in tests/unit/ (per Constitution Principle II — never optional)
...
- Tests MUST be written and MUST FAIL before implementation (Constitution Principle II — TDD non-negotiable)
...
```bash
# Launch all tests for User Story 1 together (tests are mandatory — Constitution Principle II):
